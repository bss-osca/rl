...
<!-- Q3 -->
```{r, solution=TRUE, text="The expected reward is $r(N+1,2) = 0$ and for $0 \\geq s \\geq N$ is $r(s,0) = 0$, $r(s,1) = -C_{ps}$ and $r(s,1) = -C_{f}$."}
```
...
<!-- Q2 -->
```{r, solution=TRUE, include=FALSE, text="The threshold value affect the precision of the state-value. Here values with a difference below 0.9 is considered as the same."}
...
<!-- Q4 -->
```{r, solution=TRUE, include=FALSE, text="A higher discount rate result in higher discounted rewards since look further into the future."}
