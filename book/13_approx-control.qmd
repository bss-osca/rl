...
Pseudo code for the episodic semi-gradient SARSA is given in @fig-ep-sarsa-control-approx-alg.

```{r fig-ep-sarsa-control-approx-alg, echo=FALSE, fig.cap="Episodic semi-gradient SARSA [@Sutton18].", out.width="90%"}
...
Pseudo code for the episodic n-step semi-gradient SARSA is given in @fig-ep-n-step-sarsa-control-approx-alg.

```{r fig-ep-n-step-sarsa-control-approx-alg, echo=FALSE, fig.cap="Episodic $n$-step semi-gradient SARSA [@Sutton18].", out.width="90%"}
knitr::include_graphics("img/1002_ep_n-step_sarsa.png")
```
...
Pseudo code for the continuing (differential) semi-gradient SARSA is given in @fig-cont-sarsa-control-approx-alg.

```{r fig-cont-sarsa-control-approx-alg, echo=FALSE, fig.cap="Continuing semi-gradient SARSA [@Sutton18].", out.width="90%"}
knitr::include_graphics("img/1003_cont_semi_sarsa.png")
```
...
You may solve the exercises in the corresponding sections in this [Colab notebook][colab-13-approx-control]. Use your own copy if you already have one.


### Exercise (seasonal inventory)

Solve the seasonal inventory and sales planning problem in @sec-mc-seasonal using a Fourier basis as function approximation to estimate the action-values.


### Exercise (car rental)

Consider the Car rental problem in [Exercise @sec-mdp-2-car]. Our goad is to use function approximation to estimate the optimal state value function.
