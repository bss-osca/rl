...
<div class="modal fade bs-example-modal-lg" id="XOIuQqglO499UzqGaVjx" tabindex="-1" role="dialog" aria-labelledby="XOIuQqglO499UzqGaVjx-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="XOIuQqglO499UzqGaVjx-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#XOIuQqglO499UzqGaVjx">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="F4HlwcuFBkFJ8L2Eyp5P" tabindex="-1" role="dialog" aria-labelledby="F4HlwcuFBkFJ8L2Eyp5P-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="F4HlwcuFBkFJ8L2Eyp5P-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#F4HlwcuFBkFJ8L2Eyp5P">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="r9mRUUgsa9Q80lkuqKEt" tabindex="-1" role="dialog" aria-labelledby="r9mRUUgsa9Q80lkuqKEt-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="r9mRUUgsa9Q80lkuqKEt-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#r9mRUUgsa9Q80lkuqKEt">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="rLyou5exAhc0m9A8n2Ah" tabindex="-1" role="dialog" aria-labelledby="rLyou5exAhc0m9A8n2Ah-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="rLyou5exAhc0m9A8n2Ah-title">Solution</h4></div><div class="modal-body">

<p>The reward equals the reward of rentals minus the cost of movements. Note we have \(\tilde{x} = x - a\) and \(\tilde{y} = x + a\) after movement. Hence \[r(s,a) = \mathbb{E}[10(\min(D_1, \tilde{x}) + \min(D_2, \tilde{y}) )-2\mid a \mid]\] where \[\mathbb{E}[\min(D, z)] = \sum_{i=0}^z ip(D = i) + (1-p(D\leq z))z.\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#rLyou5exAhc0m9A8n2Ah">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="DnSd8ZC9A9g1jrBQBXHa" tabindex="-1" role="dialog" aria-labelledby="DnSd8ZC9A9g1jrBQBXHa-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="DnSd8ZC9A9g1jrBQBXHa-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, y + a - \min(D_2, y+a) + H_2)).\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#DnSd8ZC9A9g1jrBQBXHa">Solution</button>
