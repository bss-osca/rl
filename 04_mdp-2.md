...
<div class="modal fade bs-example-modal-lg" id="ATJBrglwNE3FAhl0iwgX" tabindex="-1" role="dialog" aria-labelledby="ATJBrglwNE3FAhl0iwgX-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ATJBrglwNE3FAhl0iwgX-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x, y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ATJBrglwNE3FAhl0iwgX">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="3pikRZbiUmvn5a6RAoOc" tabindex="-1" role="dialog" aria-labelledby="3pikRZbiUmvn5a6RAoOc-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="3pikRZbiUmvn5a6RAoOc-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y) \leq a \leq min(5,x) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#3pikRZbiUmvn5a6RAoOc">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="lALDZKmVxTMt1cxbADWb" tabindex="-1" role="dialog" aria-labelledby="lALDZKmVxTMt1cxbADWb-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="lALDZKmVxTMt1cxbADWb-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#lALDZKmVxTMt1cxbADWb">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="I4wPJ5XxKgMi1lRNnh5S" tabindex="-1" role="dialog" aria-labelledby="I4wPJ5XxKgMi1lRNnh5S-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="I4wPJ5XxKgMi1lRNnh5S-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, \max(0, y' + a - D_2) + H_2)))\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#I4wPJ5XxKgMi1lRNnh5S">Solution</button>
