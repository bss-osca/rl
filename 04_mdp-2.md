...
<div class="modal fade bs-example-modal-lg" id="Ot0dKoxhZKItMyZG49IW" tabindex="-1" role="dialog" aria-labelledby="Ot0dKoxhZKItMyZG49IW-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Ot0dKoxhZKItMyZG49IW-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Ot0dKoxhZKItMyZG49IW">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="POEUCNRK3XGuADkzugfx" tabindex="-1" role="dialog" aria-labelledby="POEUCNRK3XGuADkzugfx-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="POEUCNRK3XGuADkzugfx-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#POEUCNRK3XGuADkzugfx">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="FQbBUAHWbCki1wWT2xNT" tabindex="-1" role="dialog" aria-labelledby="FQbBUAHWbCki1wWT2xNT-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="FQbBUAHWbCki1wWT2xNT-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#FQbBUAHWbCki1wWT2xNT">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="IHBn9JJUSXRX3NXACXIa" tabindex="-1" role="dialog" aria-labelledby="IHBn9JJUSXRX3NXACXIa-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="IHBn9JJUSXRX3NXACXIa-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#IHBn9JJUSXRX3NXACXIa">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="q9k23hz9m3PczeQtXyFr" tabindex="-1" role="dialog" aria-labelledby="q9k23hz9m3PczeQtXyFr-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="q9k23hz9m3PczeQtXyFr-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, y + a - \min(D_2, y+a) + H_2)).\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#q9k23hz9m3PczeQtXyFr">Solution</button>
