...
<div class="modal fade bs-example-modal-lg" id="i5m757nCdlTakKCNcSSa" tabindex="-1" role="dialog" aria-labelledby="i5m757nCdlTakKCNcSSa-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="i5m757nCdlTakKCNcSSa-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#i5m757nCdlTakKCNcSSa">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="RhTEaOT4JlsPQQaUydZd" tabindex="-1" role="dialog" aria-labelledby="RhTEaOT4JlsPQQaUydZd-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="RhTEaOT4JlsPQQaUydZd-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#RhTEaOT4JlsPQQaUydZd">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="D41uzTk4f5FKwX1LCqdf" tabindex="-1" role="dialog" aria-labelledby="D41uzTk4f5FKwX1LCqdf-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="D41uzTk4f5FKwX1LCqdf-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#D41uzTk4f5FKwX1LCqdf">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="ivzoM62NwYkGALEWrP5B" tabindex="-1" role="dialog" aria-labelledby="ivzoM62NwYkGALEWrP5B-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ivzoM62NwYkGALEWrP5B-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ivzoM62NwYkGALEWrP5B">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="KLYtKt8bwVfJGyTDUBHP" tabindex="-1" role="dialog" aria-labelledby="KLYtKt8bwVfJGyTDUBHP-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="KLYtKt8bwVfJGyTDUBHP-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): $$Y = \min(20, y + a - \min(D_2, y+a) + H_2)).$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#KLYtKt8bwVfJGyTDUBHP">Solution</button>
