...
<div class="modal fade bs-example-modal-lg" id="u3hFZCK8jHBQ76ZQH6GD" tabindex="-1" role="dialog" aria-labelledby="u3hFZCK8jHBQ76ZQH6GD-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="u3hFZCK8jHBQ76ZQH6GD-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#u3hFZCK8jHBQ76ZQH6GD">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="lpTdgJHsvi8vTsvK4THS" tabindex="-1" role="dialog" aria-labelledby="lpTdgJHsvi8vTsvK4THS-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="lpTdgJHsvi8vTsvK4THS-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#lpTdgJHsvi8vTsvK4THS">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="zdzORxUx8ytpzbIOAHKg" tabindex="-1" role="dialog" aria-labelledby="zdzORxUx8ytpzbIOAHKg-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="zdzORxUx8ytpzbIOAHKg-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#zdzORxUx8ytpzbIOAHKg">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="OoIAneK5ZYfOvWjx4vtr" tabindex="-1" role="dialog" aria-labelledby="OoIAneK5ZYfOvWjx4vtr-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="OoIAneK5ZYfOvWjx4vtr-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#OoIAneK5ZYfOvWjx4vtr">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="ICeS6ZlhtrJStMPLPLMo" tabindex="-1" role="dialog" aria-labelledby="ICeS6ZlhtrJStMPLPLMo-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ICeS6ZlhtrJStMPLPLMo-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, y + a - \min(D_2, y+a) + H_2)).\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ICeS6ZlhtrJStMPLPLMo">Solution</button>
