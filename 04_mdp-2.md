...
<div class="modal fade bs-example-modal-lg" id="s6y76tQHLKdAmACE5l5m" tabindex="-1" role="dialog" aria-labelledby="s6y76tQHLKdAmACE5l5m-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="s6y76tQHLKdAmACE5l5m-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x, y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#s6y76tQHLKdAmACE5l5m">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="NIyLNKNSmmsbV1fg4SnR" tabindex="-1" role="dialog" aria-labelledby="NIyLNKNSmmsbV1fg4SnR-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="NIyLNKNSmmsbV1fg4SnR-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y) \leq a \leq min(5,x) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#NIyLNKNSmmsbV1fg4SnR">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="YBOWq9Igw99xIV7Jzu9T" tabindex="-1" role="dialog" aria-labelledby="YBOWq9Igw99xIV7Jzu9T-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="YBOWq9Igw99xIV7Jzu9T-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#YBOWq9Igw99xIV7Jzu9T">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="twSxMivqfDCa0A7hvoL6" tabindex="-1" role="dialog" aria-labelledby="twSxMivqfDCa0A7hvoL6-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="twSxMivqfDCa0A7hvoL6-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, \max(0, y' + a - D_2) + H_2)))\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#twSxMivqfDCa0A7hvoL6">Solution</button>
