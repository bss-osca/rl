...
<div class="modal fade bs-example-modal-lg" id="iaV40T7UeVmbfKzGA8Xl" tabindex="-1" role="dialog" aria-labelledby="iaV40T7UeVmbfKzGA8Xl-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="iaV40T7UeVmbfKzGA8Xl-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x, y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#iaV40T7UeVmbfKzGA8Xl">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="NnfANP8pDS63HFdq54wE" tabindex="-1" role="dialog" aria-labelledby="NnfANP8pDS63HFdq54wE-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="NnfANP8pDS63HFdq54wE-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y) \leq a \leq min(5,x) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#NnfANP8pDS63HFdq54wE">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="V63zQq9Nn0Vtwf9USkFf" tabindex="-1" role="dialog" aria-labelledby="V63zQq9Nn0Vtwf9USkFf-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="V63zQq9Nn0Vtwf9USkFf-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#V63zQq9Nn0Vtwf9USkFf">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="GhoBv6x2mx8nywpvDIOZ" tabindex="-1" role="dialog" aria-labelledby="GhoBv6x2mx8nywpvDIOZ-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="GhoBv6x2mx8nywpvDIOZ-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, \max(0, y' + a - D_2) + H_2)))\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#GhoBv6x2mx8nywpvDIOZ">Solution</button>
