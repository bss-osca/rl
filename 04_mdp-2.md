...
<div class="modal fade bs-example-modal-lg" id="G6K0SlHSRD0RYFUPkc5h" tabindex="-1" role="dialog" aria-labelledby="G6K0SlHSRD0RYFUPkc5h-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="G6K0SlHSRD0RYFUPkc5h-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#G6K0SlHSRD0RYFUPkc5h">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="C0DJdPh30VEv1zT1G6pI" tabindex="-1" role="dialog" aria-labelledby="C0DJdPh30VEv1zT1G6pI-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="C0DJdPh30VEv1zT1G6pI-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#C0DJdPh30VEv1zT1G6pI">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="07aUh6DCfqUnRnAy5ZOj" tabindex="-1" role="dialog" aria-labelledby="07aUh6DCfqUnRnAy5ZOj-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="07aUh6DCfqUnRnAy5ZOj-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#07aUh6DCfqUnRnAy5ZOj">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="MY1brVygv1z3VNDSeV4A" tabindex="-1" role="dialog" aria-labelledby="MY1brVygv1z3VNDSeV4A-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="MY1brVygv1z3VNDSeV4A-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#MY1brVygv1z3VNDSeV4A">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="3SJQq2EbC5DokcuLouqE" tabindex="-1" role="dialog" aria-labelledby="3SJQq2EbC5DokcuLouqE-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="3SJQq2EbC5DokcuLouqE-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): $$Y = \min(20, y + a - \min(D_2, y+a) + H_2)).$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#3SJQq2EbC5DokcuLouqE">Solution</button>
