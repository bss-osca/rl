...
<div class="modal fade bs-example-modal-lg" id="PqNa1c5cXWIH1YdmMkdb" tabindex="-1" role="dialog" aria-labelledby="PqNa1c5cXWIH1YdmMkdb-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="PqNa1c5cXWIH1YdmMkdb-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x, y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#PqNa1c5cXWIH1YdmMkdb">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="J25SkMljmfTeNnz7jLYy" tabindex="-1" role="dialog" aria-labelledby="J25SkMljmfTeNnz7jLYy-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="J25SkMljmfTeNnz7jLYy-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y) \leq a \leq min(5,x) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#J25SkMljmfTeNnz7jLYy">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="9MbsRL5VHw3ScOspZi8Z" tabindex="-1" role="dialog" aria-labelledby="9MbsRL5VHw3ScOspZi8Z-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="9MbsRL5VHw3ScOspZi8Z-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#9MbsRL5VHw3ScOspZi8Z">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="JLc86PKvXLm5i8suLLVv" tabindex="-1" role="dialog" aria-labelledby="JLc86PKvXLm5i8suLLVv-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="JLc86PKvXLm5i8suLLVv-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, \max(0, y' + a - D_2) + H_2)))\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#JLc86PKvXLm5i8suLLVv">Solution</button>
