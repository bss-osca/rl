...
<div class="modal fade bs-example-modal-lg" id="FFLiZpM6BAwXiR0azQ1b" tabindex="-1" role="dialog" aria-labelledby="FFLiZpM6BAwXiR0azQ1b-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="FFLiZpM6BAwXiR0azQ1b-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#FFLiZpM6BAwXiR0azQ1b">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="EmjselGgqQEgjVgxPVMh" tabindex="-1" role="dialog" aria-labelledby="EmjselGgqQEgjVgxPVMh-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="EmjselGgqQEgjVgxPVMh-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#EmjselGgqQEgjVgxPVMh">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="1ZmW7tV37LhwdokJYzf2" tabindex="-1" role="dialog" aria-labelledby="1ZmW7tV37LhwdokJYzf2-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="1ZmW7tV37LhwdokJYzf2-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#1ZmW7tV37LhwdokJYzf2">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="JGXewMzmP3np5BWiE4P7" tabindex="-1" role="dialog" aria-labelledby="JGXewMzmP3np5BWiE4P7-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="JGXewMzmP3np5BWiE4P7-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#JGXewMzmP3np5BWiE4P7">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="H0YpVFrgFgebTxBXM9aJ" tabindex="-1" role="dialog" aria-labelledby="H0YpVFrgFgebTxBXM9aJ-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="H0YpVFrgFgebTxBXM9aJ-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): $$Y = \min(20, y + a - \min(D_2, y+a) + H_2)).$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#H0YpVFrgFgebTxBXM9aJ">Solution</button>
