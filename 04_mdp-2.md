...
<div class="modal fade bs-example-modal-lg" id="NpDjN7MksuKFGU8hbf62" tabindex="-1" role="dialog" aria-labelledby="NpDjN7MksuKFGU8hbf62-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="NpDjN7MksuKFGU8hbf62-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#NpDjN7MksuKFGU8hbf62">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Yx9Ro0JVQW76TP55rBtf" tabindex="-1" role="dialog" aria-labelledby="Yx9Ro0JVQW76TP55rBtf-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Yx9Ro0JVQW76TP55rBtf-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Yx9Ro0JVQW76TP55rBtf">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="GskNRVKF8bVF3sE7zRFu" tabindex="-1" role="dialog" aria-labelledby="GskNRVKF8bVF3sE7zRFu-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="GskNRVKF8bVF3sE7zRFu-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#GskNRVKF8bVF3sE7zRFu">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Et1ohjsebvabMEaU79IG" tabindex="-1" role="dialog" aria-labelledby="Et1ohjsebvabMEaU79IG-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Et1ohjsebvabMEaU79IG-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Et1ohjsebvabMEaU79IG">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="C5N5W9GxngHhOMwdnGHv" tabindex="-1" role="dialog" aria-labelledby="C5N5W9GxngHhOMwdnGHv-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="C5N5W9GxngHhOMwdnGHv-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): $$Y = \min(20, y + a - \min(D_2, y+a) + H_2)).$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#C5N5W9GxngHhOMwdnGHv">Solution</button>
