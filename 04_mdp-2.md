...
<div class="modal fade bs-example-modal-lg" id="ZrV48Xleci5tUbuaWQwD" tabindex="-1" role="dialog" aria-labelledby="ZrV48Xleci5tUbuaWQwD-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ZrV48Xleci5tUbuaWQwD-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{S} = \{ (x,y) | 0 \leq x, y \leq 20 \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ZrV48Xleci5tUbuaWQwD">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="rBte0c3tcgzlSefIQbkL" tabindex="-1" role="dialog" aria-labelledby="rBte0c3tcgzlSefIQbkL-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="rBte0c3tcgzlSefIQbkL-title">Solution</h4></div><div class="modal-body">

<p>\[\mathcal{A}(s) = \{ a | -\min(5,y) \leq a \leq min(5,x) \}\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#rBte0c3tcgzlSefIQbkL">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="VhTZ5GdSJ4Qr7ngyWESo" tabindex="-1" role="dialog" aria-labelledby="VhTZ5GdSJ4Qr7ngyWESo-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="VhTZ5GdSJ4Qr7ngyWESo-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#VhTZ5GdSJ4Qr7ngyWESo">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Q4o3RuFvLdQy9csqpdOA" tabindex="-1" role="dialog" aria-labelledby="Q4o3RuFvLdQy9csqpdOA-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Q4o3RuFvLdQy9csqpdOA-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): \[Y = \min(20, \max(0, y' + a - D_2) + H_2)))\]</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Q4o3RuFvLdQy9csqpdOA">Solution</button>
