...
<div class="modal fade bs-example-modal-lg" id="p198WGyFKcy1mqZZt8Ow" tabindex="-1" role="dialog" aria-labelledby="p198WGyFKcy1mqZZt8Ow-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="p198WGyFKcy1mqZZt8Ow-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#p198WGyFKcy1mqZZt8Ow">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="W2W5Is6cxCxrYw68Qw0V" tabindex="-1" role="dialog" aria-labelledby="W2W5Is6cxCxrYw68Qw0V-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="W2W5Is6cxCxrYw68Qw0V-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{S} = \{ (x,y) | 0 \leq x \leq 20, 0 \leq y \leq 20 \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#W2W5Is6cxCxrYw68Qw0V">Solution</button>

   1) Define the state space (with states $(x,y)$) equal the number of cars at each location at the end of the day.
   
<!-- Q2 -->

<div class="modal fade bs-example-modal-lg" id="7lo6UFLlwA88758loMDz" tabindex="-1" role="dialog" aria-labelledby="7lo6UFLlwA88758loMDz-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="7lo6UFLlwA88758loMDz-title">Solution</h4></div><div class="modal-body">

<p>$$\mathcal{A}(s) = \{ a | -\min(5,y,20-x) \leq a \leq min(5,x,20-y) \}$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#7lo6UFLlwA88758loMDz">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="KHUXDZaqyFTLzQqS1vYh" tabindex="-1" role="dialog" aria-labelledby="KHUXDZaqyFTLzQqS1vYh-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="KHUXDZaqyFTLzQqS1vYh-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#KHUXDZaqyFTLzQqS1vYh">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="llBThfoH8YD7qJFPP4Hx" tabindex="-1" role="dialog" aria-labelledby="llBThfoH8YD7qJFPP4Hx-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="llBThfoH8YD7qJFPP4Hx-title">Solution</h4></div><div class="modal-body">

<p>Only difference is that cars moved to Location 2 is \(a\) (and not \(-a\)): $$Y = \min(20, y + a - \min(D_2, y+a) + H_2)).$$</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#llBThfoH8YD7qJFPP4Hx">Solution</button>
