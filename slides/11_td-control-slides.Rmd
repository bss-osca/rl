...
* Last lecture: TD methods for prediction. This lecture: TD for control (improve the policy).
...
* Let us have a look at the [Colab notebook][colab-11-td-control] for this module.
