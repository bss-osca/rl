...
VI does not require a stored policy. Instead after the last step of value-iteration the optimal policy $\pi^\star$ is found:
...
```{r policy-ite-alg, echo=FALSE, out.width="70%"}
