...
- A combination of lectures and tutorials. 
  - Before: Read the suggested material (you may also start the exercises).
...
- How much work am I expected to do in a 10 ECTS course? 
  - Given 30 ECTS per semester and 40 hours study per week.
  - Then 40/3 hours, which approx is 13 hours/week, i.e. 9 hours off-class. 
...
- See the [Colab introduction][colab-01-intro-colab] notebook.
...
- A 20-minute oral individual exam without any preparation. 
- Curriculum includes all material such as book chapters, course notes, videos, interactive tutorials, exercises and project reports.
- The report may be used as a starting point for discussion at the individual exam.
- If no report is handed in, we do theoretical stuff instead.
