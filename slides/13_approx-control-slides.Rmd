...
- Continuing case: Discounting is not suitable to find an optimal policy. Here we have to swithc from the discounting objective to an average-reward objective.
...
- From prediction into control techniques for policy improvement and action selection are needed. 
- Action set is discrete and not too large: Can use techniques developed so far:
...
$$
\bar R \leftarrow \bar R + \beta\delta_t^q.
$$
