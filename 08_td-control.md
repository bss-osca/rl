...
<div class="modal fade bs-example-modal-lg" id="uf5FoYvXdbFg2D27gojm" tabindex="-1" role="dialog" aria-labelledby="uf5FoYvXdbFg2D27gojm-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="uf5FoYvXdbFg2D27gojm-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#uf5FoYvXdbFg2D27gojm">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="v7k4T50S8guJRviReqyo" tabindex="-1" role="dialog" aria-labelledby="v7k4T50S8guJRviReqyo-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="v7k4T50S8guJRviReqyo-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#v7k4T50S8guJRviReqyo">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="74TUu7myUfLXn3wSpZ6F" tabindex="-1" role="dialog" aria-labelledby="74TUu7myUfLXn3wSpZ6F-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="74TUu7myUfLXn3wSpZ6F-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#74TUu7myUfLXn3wSpZ6F">Solution</button>
...
#> (s,a,r,s,a) = (3,keep,-60,4,empty), r = -60 oldQ = 0 Q(sN, aN) = 0 newQ = -6
#> (s,a,r,s,a) = (4,empty,-45,1,empty), r = -45 oldQ = 0 Q(sN, aN) = 0 newQ = -4.5
#> (s,a,r,s,a) = (1,empty,-30,0,keep), r = -30 oldQ = 0 Q(sN, aN) = 0 newQ = -3
#> (s,a,r,s,a) = (0,keep,0,2,empty), r = 0 oldQ = 0 Q(sN, aN) = 0 newQ = 0
#> (s,a,r,s,a) = (2,empty,-35,0,keep), r = -35 oldQ = 0 Q(sN, aN) = 0 newQ = -3.5
...
#> (s,a,r,s) = (3,empty,-40,3), r = -40 oldQ = 0 maxQ(sN) = 0 newQ = -4
#> (s,a,r,s) = (3,keep,-60,4), r = -60 oldQ = 0 maxQ(sN) = 0 newQ = -6
#> (s,a,r,s) = (4,keep,-60,4), r = -60 oldQ = 0 maxQ(sN) = 0 newQ = -6
...
#> (s,a,r,s) = (2,empty,-35,1), r = -35 oldQ = 0 expQ(sN) = 0 newQ = -3.5
...
<div class="modal fade bs-example-modal-lg" id="31qhsbVZ0WIfdUouHP9g" tabindex="-1" role="dialog" aria-labelledby="31qhsbVZ0WIfdUouHP9g-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="31qhsbVZ0WIfdUouHP9g-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#31qhsbVZ0WIfdUouHP9g">Solution</button>
