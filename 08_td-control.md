...
<div class="modal fade bs-example-modal-lg" id="VLKVCAznbZdEs8NaYF8J" tabindex="-1" role="dialog" aria-labelledby="VLKVCAznbZdEs8NaYF8J-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="VLKVCAznbZdEs8NaYF8J-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#VLKVCAznbZdEs8NaYF8J">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Wxx6qccvLGivI8Bgamcj" tabindex="-1" role="dialog" aria-labelledby="Wxx6qccvLGivI8Bgamcj-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Wxx6qccvLGivI8Bgamcj-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Wxx6qccvLGivI8Bgamcj">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="GKve84q7I792Pec0nziu" tabindex="-1" role="dialog" aria-labelledby="GKve84q7I792Pec0nziu-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="GKve84q7I792Pec0nziu-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#GKve84q7I792Pec0nziu">Solution</button>
...
#> (s,a,r,s,a) = (4,empty,-45,3,empty), r = -45 oldQ = 0 Q(sN, aN) = 0 newQ = -4.5
#> (s,a,r,s,a) = (3,empty,-40,1,empty), r = -40 oldQ = 0 Q(sN, aN) = 0 newQ = -4
#> (s,a,r,s,a) = (1,empty,-30,3,keep), r = -30 oldQ = 0 Q(sN, aN) = 0 newQ = -3
#> (s,a,r,s,a) = (3,keep,-60,4,keep), r = -60 oldQ = 0 Q(sN, aN) = 0 newQ = -6
...
#> (s,a,r,s) = (3,keep,0,3), r = 0 oldQ = 0 maxQ(sN) = 0 newQ = 0
...
#> (s,a,r,s) = (1,keep,0,4), r = 0 oldQ = 0 expQ(sN) = 0 newQ = 0
...
<div class="modal fade bs-example-modal-lg" id="cEWOFcqn0FepNS8eozkT" tabindex="-1" role="dialog" aria-labelledby="cEWOFcqn0FepNS8eozkT-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="cEWOFcqn0FepNS8eozkT-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#cEWOFcqn0FepNS8eozkT">Solution</button>
