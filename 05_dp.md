...
<div class="modal fade bs-example-modal-lg" id="hZgH7tBv5tlm2ni2miPO" tabindex="-1" role="dialog" aria-labelledby="hZgH7tBv5tlm2ni2miPO-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="hZgH7tBv5tlm2ni2miPO-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#hZgH7tBv5tlm2ni2miPO">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="ORmP2lvJjSgOlmiPgT3m" tabindex="-1" role="dialog" aria-labelledby="ORmP2lvJjSgOlmiPgT3m-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ORmP2lvJjSgOlmiPgT3m-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ORmP2lvJjSgOlmiPgT3m">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="9Bvu7fYhXAjr40W9cpTH" tabindex="-1" role="dialog" aria-labelledby="9Bvu7fYhXAjr40W9cpTH-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="9Bvu7fYhXAjr40W9cpTH-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#9Bvu7fYhXAjr40W9cpTH">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="pMgIJbUDttirEyQVJ7oq" tabindex="-1" role="dialog" aria-labelledby="pMgIJbUDttirEyQVJ7oq-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="pMgIJbUDttirEyQVJ7oq-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#pMgIJbUDttirEyQVJ7oq">Solution</button>
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#KaVaqnWuAY0cJ2MHhHwN">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="clKVSJtgRsK6ZU0SgvJ3" tabindex="-1" role="dialog" aria-labelledby="clKVSJtgRsK6ZU0SgvJ3-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="clKVSJtgRsK6ZU0SgvJ3-title">Solution</h4></div><div class="modal-body">

<p>The expected reward is \(r(N+1,2) = 0\) and for \(0 < s < N\) is \(r(s,0) = 0\), \(r(s,1) = -C_{ps}\). Finally, \(r(N,2) = -C_{f}\) and \(r(N+1,2) = 0\).</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#clKVSJtgRsK6ZU0SgvJ3">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="V14mHiWLLamkRGydfnl1" tabindex="-1" role="dialog" aria-labelledby="V14mHiWLLamkRGydfnl1-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="V14mHiWLLamkRGydfnl1-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#V14mHiWLLamkRGydfnl1">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="4mydvupHWn0ZgbdNdcMN" tabindex="-1" role="dialog" aria-labelledby="4mydvupHWn0ZgbdNdcMN-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="4mydvupHWn0ZgbdNdcMN-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#4mydvupHWn0ZgbdNdcMN">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="rzEGYMlIhqo6mW5JOslC" tabindex="-1" role="dialog" aria-labelledby="rzEGYMlIhqo6mW5JOslC-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="rzEGYMlIhqo6mW5JOslC-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#rzEGYMlIhqo6mW5JOslC">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="sQCCASxH0wjyHDz8A3iL" tabindex="-1" role="dialog" aria-labelledby="sQCCASxH0wjyHDz8A3iL-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="sQCCASxH0wjyHDz8A3iL-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#sQCCASxH0wjyHDz8A3iL">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="LEGcHXmn0dmL68RV8hom" tabindex="-1" role="dialog" aria-labelledby="LEGcHXmn0dmL68RV8hom-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="LEGcHXmn0dmL68RV8hom-title">Hint</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#LEGcHXmn0dmL68RV8hom">Hint</button>
