...
<div class="modal fade bs-example-modal-lg" id="vIyKK6m1Gix7ZU5L9xAz" tabindex="-1" role="dialog" aria-labelledby="vIyKK6m1Gix7ZU5L9xAz-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="vIyKK6m1Gix7ZU5L9xAz-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#vIyKK6m1Gix7ZU5L9xAz">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Nbjmlr7SGQLs6QJGsrCl" tabindex="-1" role="dialog" aria-labelledby="Nbjmlr7SGQLs6QJGsrCl-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Nbjmlr7SGQLs6QJGsrCl-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Nbjmlr7SGQLs6QJGsrCl">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="mpNdvWtYo378AyK8ytwX" tabindex="-1" role="dialog" aria-labelledby="mpNdvWtYo378AyK8ytwX-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="mpNdvWtYo378AyK8ytwX-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#mpNdvWtYo378AyK8ytwX">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="2g0JPy8OojEF4ztp1EZC" tabindex="-1" role="dialog" aria-labelledby="2g0JPy8OojEF4ztp1EZC-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="2g0JPy8OojEF4ztp1EZC-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#2g0JPy8OojEF4ztp1EZC">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Gn3iLIC0H4zpFhouB4ak" tabindex="-1" role="dialog" aria-labelledby="Gn3iLIC0H4zpFhouB4ak-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Gn3iLIC0H4zpFhouB4ak-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Gn3iLIC0H4zpFhouB4ak">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="kPplXoVzn2GnI2i1vBmd" tabindex="-1" role="dialog" aria-labelledby="kPplXoVzn2GnI2i1vBmd-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="kPplXoVzn2GnI2i1vBmd-title">Solution</h4></div><div class="modal-body">

<p>The expected reward is \(r(N+1,2) = 0\) and for \(0 < s < N\) is \(r(s,0) = 0\), \(r(s,1) = -C_{ps}\). Finally, \(r(N,2) = -C_{f}\) and \(r(N+1,2) = 0\).</p>

</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#kPplXoVzn2GnI2i1vBmd">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="I9IHX6iF5neC6ZOUdzv4" tabindex="-1" role="dialog" aria-labelledby="I9IHX6iF5neC6ZOUdzv4-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="I9IHX6iF5neC6ZOUdzv4-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#I9IHX6iF5neC6ZOUdzv4">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="wnOI9pWnzdF8Ifjlpyja" tabindex="-1" role="dialog" aria-labelledby="wnOI9pWnzdF8Ifjlpyja-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="wnOI9pWnzdF8Ifjlpyja-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#wnOI9pWnzdF8Ifjlpyja">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="ujrzzo4P0AA5gbdRtOfC" tabindex="-1" role="dialog" aria-labelledby="ujrzzo4P0AA5gbdRtOfC-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="ujrzzo4P0AA5gbdRtOfC-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#ujrzzo4P0AA5gbdRtOfC">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="Re6jYVKjbRMGht0E0Yhx" tabindex="-1" role="dialog" aria-labelledby="Re6jYVKjbRMGht0E0Yhx-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="Re6jYVKjbRMGht0E0Yhx-title">Solution</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#Re6jYVKjbRMGht0E0Yhx">Solution</button>
...
<div class="modal fade bs-example-modal-lg" id="nXHIwrj7CZOcfgMf4GDk" tabindex="-1" role="dialog" aria-labelledby="nXHIwrj7CZOcfgMf4GDk-title"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="nXHIwrj7CZOcfgMf4GDk-title">Hint</h4></div><div class="modal-body">
...
</div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div><button class="btn btn-default btn-xs" style="float:right" data-toggle="modal" data-target="#nXHIwrj7CZOcfgMf4GDk">Hint</button>
